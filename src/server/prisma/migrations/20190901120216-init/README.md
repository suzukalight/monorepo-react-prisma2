# Migration `20190901120216-init`

This migration has been generated by mkubara at 9/1/2019, 12:02:16 PM.
...
You can use a specific Photon built for this migration (20190901120216-init)
in your `before` or `after` migration script like this:

```ts
import Photon from '@generated/photon/20190901120216-init'
